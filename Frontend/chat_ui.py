...
def handle_mri_analysis(session_id, message_key, api_url):
    try:
        ...
        prompt = (
            f"Explain these MRI results: Class {analysis['class']}, "
            f"Confidence {analysis['confidence']}%, Status {analysis['cancer_status']}. "
            f"Use patient-friendly language."
            f"Write a Precautioner Note at the start of the message."
            f"provide answer as if you are a doctor and the patient is in front of you."
        )
